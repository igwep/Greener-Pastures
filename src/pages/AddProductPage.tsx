            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('tiktokUrl', e.target.value || null)}
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('instagramUrl', e.target.value || null)}
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('otherUrl', e.target.value || null)}
      ...
      >
        <div className="text-center py-4">
          ...
          <p className="text-sm text-ink-secondary">
            Your product is now pending approval and will be visible to other users once approved.
          </p>
        </div>
      </Modal>
    </motion.div>
