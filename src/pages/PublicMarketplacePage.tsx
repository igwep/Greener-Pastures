  ...
  return (
    <PublicLayout>
      <motion.div
        ...
        className="space-y-8 py-12 px-4"
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-16 text-center">
            <Card className="p-8 rounded-3xl border-none shadow-sm bg-gradient-to-r from-ajo-50 to-green-50">
              <h2 className="text-2xl font-bold text-ink mb-4">
                Want to sell on our marketplace?
              </h2>
              <p className="text-ink-secondary mb-6 max-w-2xl mx-auto">
                Join thousands of users selling items safely on Greener Pastures. 
                Create an account and start listing your products today.
              </p>
              <Link to="/register">
